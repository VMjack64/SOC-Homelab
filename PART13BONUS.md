...
[Part 13: The Bonus Challenge](#part-13-the-bonus-challenge-running-a-real-malware-and-analyzing-its-activity-using-splunk)
- [Preparations](#preparations)
  - [Playing with Wireshark](#playing-with-wireshark)
- [Setup Process](#setup-process)
- [Running the Malware](#running-the-malware)
- [Analyzing the Malware’s Activity](#analyzing-the-malwares-activity)
  - [view.exe Events](#viewexe-events)
  - [Start.cmd Events](#startcmd-events)
  - [Start.cmd #2 Events](#startcmd-2-events)
  - [testvb1.vbs Events](#testvb1vbs-events)
  - [Start2.cmd Events](#start2cmd-events)
  - [Start2.cmd #2 Events](#start2cmd-2-events)
  - [uac.cmd Events](#uaccmd-events)
  - [uac.cmd #2 Events](#uaccmd-2-events)
- [A Different Approach](#a-different-approach)
  - [EventCode 22 (DNS Queries)](#eventcode-22-dns-queries)
  - [EventCode 6 (Driver Loaded)](#eventcode-6-driver-loaded)
  - [EventCode 1 (Process executed)](#eventcode-1-process-executed)
  - [EventCode 3 (Network Connections)](#eventcode-3-network-connections)
  - [EventCode 17 & 18 (PipeEvent; Pipe Created & Pipe Connected)](#eventcode-17--18-pipeevent-pipe-created--pipe-connected)
  - [EventCode 10 (ProcessAccess)](#eventcode-10-processaccess)
  - [Others](#others)
- [Attempting to use Wireshark to find more Information](#attempting-to-use-wireshark-to-find-more-information)
