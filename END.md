...
Something I'd like to add is that as my very first time attempting a SOC analyst project, good chances are I made some misjudgements along the way. Some examples that come to mind include:
...
- **Learn AI**. I've heard so many stories about this tool that at this point, it's abundantly clear to me that learning this is my highest priority. Having heard many stories about AI and the future, it’s become clear to me that if I’m going to succeed in today’s cybersecurity industry, having proficiency with this tool is a must. Knowledge of this tool would enable efficient SOC analysis workflows, using it to take care of repetitive alerts so that I can direct my focus onto more interesting ones.
- **Expand knowledge on networks**. While this home lab has helped me learn the fundamentals of networks, I want to continue expanding this knowledge, getting a grasp on things like the TCP/IP & OSI models and TLS.
